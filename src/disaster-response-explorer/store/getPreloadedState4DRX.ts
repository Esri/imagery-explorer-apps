...
const getPreloadedChangeCompareToolState = (hashParams: URLSearchParams) => {
    ...
    const preloadedState: ChangeCompareToolState = {
        ...
        fullPixelValuesRange: [-255, 255], // for DRX, the change compare layer is generated by doing minus operation between two grayscale rasters, so the pixel value range is from -255 to 255,
        selectedRange: [-255, 255],
    };
