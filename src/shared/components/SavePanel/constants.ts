...
> = {
    [PublishAndDownloadJobType.PublishScene]: {
        ...
        action: 'Publish',
        inputName: 'scene',
        outputName: 'publish_output_imagery_layer',
        // inputName: 'Scene',
    ...
    [PublishAndDownloadJobType.SaveWebMappingApp]: {
        ...
        outputName: 'publish_output_web_application',
    ...
    [PublishAndDownloadJobType.SaveWebMap]: {
        ...
        // inputName: 'Scene',
        inputName: 'scene',
        outputName: 'publish_output_web_map',
        requireUniqueOutputName: false,
    ...
    [PublishAndDownloadJobType.SaveWebMapWithMultipleScenes]: {
        ...
        // inputName: 'Scenes',
        inputName: 'scenes',
        outputName: 'publish_output_multi_layers_map',
        requireUniqueOutputName: false,
