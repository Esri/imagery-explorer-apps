        ...
        >
            ...
            >
                <calcite-button
                    ...
                    label="open about this app dialog"
                />
                {/* <svg
            ...
            {showLanguageSwitcherToggleButton && (
                <div
                    className="h-app-header-size w-app-header-size theme-background border-l border-custom-light-blue-50 pl-2 flex items-center"
                    style={{
