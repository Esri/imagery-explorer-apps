...
/**
 * Application ID for Disaster Imagery Explorer app.
 * Required for ArcGIS OAuth authentication for features such as saving web maps.
 * This is defined in the environment variable `ENV_DISASTER_IMAGERY_EXPLORER_APP_ID` by Webpack DefinePlugin.
 */
export const DISASTER_IMAGERY_EXPLORER_APP_ID =
    ENV_DISASTER_IMAGERY_EXPLORER_APP_ID || '';

/**
 * URL of the disaster response service for Disaster Imagery Explorer app.
