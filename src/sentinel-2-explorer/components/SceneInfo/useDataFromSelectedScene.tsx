...
import { selectAvailableScenesByObjectId } from '@shared/store/Sentinel2/selectors';
...
export const useDataFromSelectedLandsatScene = () => {
    ...
    const [sentinel2Scene, setSentinel2Scene] = useState<Sentinel2Scene>();
        ...
        (async () => {
            ...
            try {
                const data =
                    ...
                    (await getSentinel2SceneByObjectId(
                        objectIdOfSelectedScene
                    ));

                setSentinel2Scene(data);
            } catch (err) {
                console.error(err);
            }
        })();
