...
import { useSentinel2TemporalProfileDataAsChartData } from './useTemporalProfileDataAsChartData';
...
export const Sentinel2TemporalProfileChart = () => {
    const chartData = useSentinel2TemporalProfileDataAsChartData();
