...
export const createRasterFunction4ZonalMean = (
    dataAggregationServiceURl: string,
    token: string
): RasterAnalysisRasterFunction => {
    if (!dataAggregationServiceURl) {
        throw new Error(
            'Data aggregation service URL is required to create raster function for zonal mean calculation.'
        );
    }

    if (!token) {
        throw new Error(
            'Token is required to create raster function for zonal mean calculation.'
        );
    }

    const inputServiceUrl = `${dataAggregationServiceURl}?token=${token}`;

    return {
        description: '',
        name: 'Landsat Level-2 SIUHI - Part 2 of 3 - Zonal Mean',
        arguments: {
            type: 'GPAdapterFunctionArguments',
            ToolName: {
                name: 'ToolName',
                value: 'ZonalStatistics_sa',
                isDataset: false,
                isPublic: false,
            ...
            in_zone_data: {
                description:
                    'Converts each cell value of a raster into an integer by truncation.',
                name: 'in_zone_data',
                arguments: {
                                            ...
                                            arguments: {
                                                ...
                                                Raster: {
                                                    ...
                                                    function: {
                                                        ...
                                                        pixelType: 'UNKNOWN',
                                                        name: 'Cloud Free Seasonal Mean Raster',
                                                        description:
                                                            'Specifies which bands to work with when using multiband datasets.',
                                                        _object_id: 26,
                                                    },
            ...
            percentile_interpolation_type: {
                name: 'percentile_interpolation_type',
                value: 'AUTO_DETECT',
                isDataset: false,
                isPublic: false,
                type: 'RasterFunctionVariable',
            ...
            process_as_multidimensional: {
                name: 'process_as_multidimensional',
                value: 'CURRENT_SLICE',
                isDataset: false,
                isPublic: false,
                type: 'RasterFunctionVariable',
        ...
        function: {
            ...
            pixelType: 'UNKNOWN',
            name: 'Surface Temperature Zonal Mean of Non - Built Pixels',
            description:
        ...
        type: 'RasterFunctionTemplate',
        _object_id: 1,
        sourceItemId: 'bb7713fd37134fb78c8beb6736fc4668',
    };
};
