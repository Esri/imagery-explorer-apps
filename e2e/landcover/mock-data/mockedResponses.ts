    ...
    features: [
        {
            attributes: {
                ...
                PopupText: 'water',
                Description:
                    'Areas where water was predominantly present throughout the year; may not cover areas with sporadic or ephemeral water; contains little to no sparse vegetation, no rock outcrop nor built up features like docks.',
        ...
        },
        {
            attributes: {
                ...
                PopupText: 'trees',
                Description:
                    'Any significant clustering of tall (~15-m or higher) dense vegetation, typically with a closed or dense canopy.',
                Examples:
                    'Wooded vegetation,  clusters of dense tall vegetation within savannas, plantations, swamp or mangroves (dense/tall vegetation with ephemeral water or canopy too thick to detect water underneath).',
            },
        },
        {
            attributes: {
                ...
                Description:
                    'Areas of any type of vegetation with obvious intermixing of water throughout a majority of the year; seasonally flooded area that is a mix of grass/shrub/trees/bare ground.',
                Examples:
                    'Flooded mangroves, emergent vegetation, rice paddies and other heavily irrigated and inundated agriculture.',
            },
        },
        {
            attributes: {
        ...
        },
        {
            attributes: {
                ...
                Description:
                    'Human made structures; major road and rail networks; large homogenous impervious surfaces including parking structures, office buildings and residential housing.',
                Examples:
        ...
        },
        {
            attributes: {
                ...
                Description:
                    'Areas of rock or soil with very sparse to no vegetation for the entire year; large areas of sand and deserts with no to little vegetation.',
                Examples:
                    'Exposed rock or soil, desert and sand dunes, dry salt flats/pans, dried lake beds, mines.',
            },
        },
        {
            attributes: {
                ...
                Description:
                    'Large homogenous areas of permanent snow or ice, typically only in mountain areas or highest latitudes.',
        ...
        },
        {
            attributes: {
                ...
                PopupText: 'rangeland',
                Description:
                    'Open areas covered in homogenous grasses with little to no taller vegetation; wild cereals and grasses, Mix of small clusters of plants or single plants dispersed on a landscape that shows exposed soil or rock; scrub-filled clearings within forests that are clearly not taller than trees.',
                Examples:
                    'Natural meadows and fields with sparse to no tree cover, open savanna with few to no trees, parks/golf courses/lawns, pastures, moderate to sparse cover of bushes, shrubs and tufts of grass, savannas with very sparse grasses, trees or other plants.',
            },
        },
        {
            attributes: {
...
export const mockedSentinel2LandcoverServiceJSONResponse = {
    ...
    minValues: [0],
    maxValues: [11],
    meanValues: [7.281947135864333],
    stdvValues: [3.6240001343670425],
    hasMultidimensions: false,
    timeInfo: {
        startTimeField: 'StartDate',
        endTimeField: 'EndDate',
        timeExtent: [1483228800000, 1735689599000],
        timeReference: null,
    },
    ...
    allowedMosaicMethods:
        'ByAttribute,NorthWest,Center,LockRaster,Nadir,Viewpoint,None',
    sortField: 'Year',
    sortValue: '2050',
    sortAscending: true,
    ...
    rasterFunctionInfos: [
        {
            ...
            description:
                'Legend and attribute table for Sentinel 2 10m Land Cover.',
            help: '',
        },
        {
            name: 'None',
            description:
                'Make a Raster or Raster Dataset into a Function Raster Dataset.',
            help: '',
        },
        {
    ...
    histograms: [
        {
            ...
            min: -0.5,
            max: 11.5,
            counts: [0, 50, 100, 0, 100, 250, 0, 500, 1, 0, 0, 1000],
        },
    ],
};
