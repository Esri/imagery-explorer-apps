    ...
    return {
        ...
        plugins: [
            ...
            new DefinePlugin({
                 ...
                 */
                ENV_IMAGERY_EXPLORER_WEB_MAP_ID: JSON.stringify(envConfig.IMAGERY_EXPLORER_WEB_MAP_ID),
                /**
                 * Web map ID for the Land Cover Explorer app.
                 * Optional: defaults to `81609bbe235942919ad27c77e42c600e` if not specified.
                 */
                ENV_LANDCOVER_EXPLORER_WEB_MAP_ID: JSON.stringify(envConfig.LANDCOVER_EXPLORER_WEB_MAP_ID),
            }),
